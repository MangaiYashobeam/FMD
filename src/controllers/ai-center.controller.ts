...
const DEFAULT_PROVIDERS = [
  {
    ...
    availableModels: ['claude-sonnet-4-20250514', 'claude-opus-4-20250514', 'claude-haiku-3-5-20241022'],
  ...
  },
  {
    ...
    availableModels: ['gpt-4-turbo', 'gpt-4o', 'gpt-4o-mini', 'o1', 'o1-mini'],
  ...
  },
  {
    ...
    healthStatus: process.env.MISTRAL_API_KEY ? 'healthy' : 'unknown',
    capabilities: ['text', 'code', 'analysis'],
  ...
  },
  {
    ...
    type: 'perplexity',
    isActive: !!process.env.PERPLEXITY_API_KEY,
    defaultModel: 'sonar-pro',
    availableModels: ['sonar-pro', 'sonar', 'sonar-reasoning'],
    healthStatus: process.env.PERPLEXITY_API_KEY ? 'healthy' : 'unknown',
    capabilities: ['text', 'analysis', 'search'],
    apiKey: process.env.PERPLEXITY_API_KEY ? '***configured***' : null,
  },
  {
    id: 'deepseek',
    name: 'DeepSeek',
  ...
  },
  {
    ...
    displayName: 'Google',
    type: 'google',
    isActive: !!process.env.GOOGLE_AI_KEY,
    defaultModel: 'gemini-2.0-flash',
    availableModels: ['gemini-2.0-flash', 'gemini-1.5-pro'],
    healthStatus: process.env.GOOGLE_AI_KEY ? 'healthy' : 'unknown',
    capabilities: ['text', 'vision', 'file-processing'],
    apiKey: process.env.GOOGLE_AI_KEY ? '***configured***' : null,
  },
  {
    id: 'meta',
    name: 'Meta Llama',
    displayName: 'Meta',
    type: 'meta',
    isActive: !!process.env.TOGETHER_API_KEY,
    defaultModel: 'llama-3.3-70b',
    availableModels: ['llama-3.3-70b', 'llama-3.1-8b'],
    healthStatus: process.env.TOGETHER_API_KEY ? 'healthy' : 'unknown',
    capabilities: ['text', 'code', 'analysis'],
    apiKey: process.env.TOGETHER_API_KEY ? '***configured***' : null,
  },
  {
    id: 'cohere',
    name: 'Cohere',
    ...
    healthStatus: process.env.COHERE_API_KEY ? 'healthy' : 'unknown',
    capabilities: ['text', 'code', 'analysis'],
    apiKey: process.env.COHERE_API_KEY ? '***configured***' : null,
  },
];
